...
export function PostHead({ post }: { post: Post }) {
  return (
    <>
      <h1 className="text-4xl font-bold mt-6 md:mt-12 mb-2 text-center">{post.meta.title}</h1>
      <p className="text-sm text-muted-foreground text-center mb-2">{post.meta.description}</p>
