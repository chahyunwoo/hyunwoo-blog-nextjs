...
const colors: Record<CalloutType, string> = {
  default: 'border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-800 text-gray-800 dark:text-gray-200',
  ...
  error: 'border-red-200 bg-red-100 dark:border-red-800 dark:bg-red-900/30 text-red-800 dark:text-red-200',
  tip: 'border-purple-200 bg-purple-100 dark:border-purple-800 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200',
}

export function Callout({ children, type = 'default', icon, className, ...props }: CalloutProps) {
  const IconComponent = icon || icons[type]

  return (
    <div className={cn('my-6 flex gap-4 rounded-lg border px-4 py-1 items-center', colors[type], className)} {...props}>
