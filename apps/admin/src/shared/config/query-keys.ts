export const queryKeys = {
  ...
  analytics: {
    ...
    popularPosts: (limit: number, days?: number) => ['analytics', 'popular-posts', limit, days] as const,
    referrers: (days: number, app: string) => ['analytics', 'referrers', days, app] as const,
    visitorsTimeline: (days: number, app: string) => ['analytics', 'visitors', 'timeline', days, app] as const,
