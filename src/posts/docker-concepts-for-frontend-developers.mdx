...
프론트엔드 개발자도 Docker 기초 정도는 알아두면 좋다고 생각합니다. 저도 이 개념을 알고 나서 [맥미니로 홈서버를 구축](/blog/mac-homeserver-tailscale-ssh)하면서 Docker Compose로 서비스를 운영하게 되었는데, 기초를 알고 있으니 훨씬 수월했습니다.
