...
[현재 블로그](https://chahyunwoo.dev)의 개발 과정에 대해서는 [해당 포스트](https://chahyunwoo.dev/posts/how-to-make-blog-with-nextjs)에서 자세히 설명할 예정이며 오늘은 Next13과 Next15의 차이점에 대해서 기술하려고 합니다.
...
해당 블로그 마이그레이션에 대한 자세한 내용은 [해당 포스트](https://chahyunwoo.dev/posts/how-to-make-blog-with-nextjs)를 참고 부탁드립니다.
