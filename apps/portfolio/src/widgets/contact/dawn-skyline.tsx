export function DawnSkyline() {
  return (
    <div className="relative mt-12 overflow-hidden" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)' }}>
      {/* Desktop */}
      <div className="hidden md:block" style={{ height: '220px' }}>
        <svg
      ...
      {/* Mobile */}
      <div className="md:hidden" style={{ height: '200px' }}>
        <svg
          viewBox="0 0 390 200"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          {/* Horizon glow */}
          <ellipse cx="195" cy="200" rx="220" ry="40" fill="rgba(168,85,247,0.05)" />
          <ellipse cx="195" cy="200" rx="120" ry="25" fill="rgba(251,146,60,0.04)" />

          {/* Mountains (far back) */}
          <polygon
            points="0,200 0,110 50,70 110,100 175,45 240,85 310,40 370,75 390,60 390,200"
            fill="rgba(255,255,255,0.025)"
          />

          {/* Hills (mid) */}
          <polygon
            points="0,200 0,155 60,130 130,148 200,120 270,142 340,125 390,140 390,200"
            fill="rgba(255,255,255,0.04)"
          />

          {/* Tall buildings */}
          <rect x="20" y="100" width="22" height="100" rx="1" fill="rgba(255,255,255,0.06)" />
          <rect x="46" y="118" width="16" height="82" rx="1" fill="rgba(255,255,255,0.05)" />

          <rect x="155" y="92" width="26" height="108" rx="1" fill="rgba(255,255,255,0.065)" />
          <rect x="185" y="110" width="18" height="90" rx="1" fill="rgba(255,255,255,0.05)" />

          <rect x="320" y="88" width="24" height="112" rx="1" fill="rgba(255,255,255,0.06)" />
          <rect x="348" y="106" width="18" height="94" rx="1" fill="rgba(255,255,255,0.05)" />

          {/* Short buildings */}
          <rect x="90" y="158" width="32" height="42" rx="1" fill="rgba(255,255,255,0.075)" />
          <rect x="260" y="155" width="36" height="45" rx="1" fill="rgba(255,255,255,0.075)" />

          {/* Houses with roofs (prominent) */}
          <rect x="118" y="168" width="30" height="32" rx="1" fill="rgba(255,255,255,0.09)" />
          <polygon points="115,168 133,148 151,168" fill="rgba(255,255,255,0.09)" />

          <rect x="230" y="165" width="28" height="35" rx="1" fill="rgba(255,255,255,0.09)" />
          <polygon points="227,165 244,144 261,165" fill="rgba(255,255,255,0.09)" />

          {/* Windows on tall buildings */}
          <rect x="161" y="105" width="5" height="5" rx="0.5" fill="rgba(251,191,36,0.35)" />
          <rect x="170" y="105" width="5" height="5" rx="0.5" fill="rgba(251,191,36,0.2)" />
          <rect x="161" y="118" width="5" height="5" rx="0.5" fill="rgba(251,191,36,0.25)" />
          <rect x="326" y="100" width="5" height="5" rx="0.5" fill="rgba(251,191,36,0.3)" />
          <rect x="335" y="115" width="5" height="5" rx="0.5" fill="rgba(251,191,36,0.2)" />
          <rect x="26" y="113" width="4" height="4" rx="0.5" fill="rgba(251,191,36,0.25)" />
          <rect x="34" y="126" width="4" height="4" rx="0.5" fill="rgba(251,191,36,0.2)" />

          {/* Windows on houses */}
          <rect x="123" y="178" width="6" height="7" rx="0.5" fill="rgba(251,191,36,0.4)" />
          <rect x="133" y="178" width="6" height="7" rx="0.5" fill="rgba(251,191,36,0.25)" />
          <rect x="236" y="175" width="6" height="7" rx="0.5" fill="rgba(251,191,36,0.4)" />
          <rect x="245" y="175" width="6" height="7" rx="0.5" fill="rgba(251,191,36,0.25)" />

          {/* Street lamps */}
          <rect x="78" y="165" width="3" height="35" fill="rgba(255,255,255,0.08)" />
          <rect x="72" y="163" width="15" height="3" rx="1" fill="rgba(255,255,255,0.08)" />
          <ellipse cx="79" cy="161" rx="7" ry="4" fill="rgba(251,191,36,0.12)" />

          <rect x="300" y="162" width="3" height="38" fill="rgba(255,255,255,0.08)" />
          <rect x="294" y="160" width="15" height="3" rx="1" fill="rgba(255,255,255,0.08)" />
          <ellipse cx="301" cy="158" rx="7" ry="4" fill="rgba(251,191,36,0.12)" />

          {/* Ground */}
          <rect x="0" y="198" width="390" height="2" fill="rgba(255,255,255,0.05)" />
        </svg>
      </div>
    </div>
  )
